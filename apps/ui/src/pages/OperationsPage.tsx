...
export default function OperationsPage() {
  ...
  return (
    <>
      ...
      <DataState loading={loading} empty={crons.length === 0 && watchdogs.length === 0 && audit.length === 0} emptyTitle="No operations" emptyDescription="No scheduled operations." loadingText="Loading operations...">
        {/* Summary stats */}
