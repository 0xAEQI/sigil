export default function Installation() {
  return (
    <>
      ...
      <pre><code>{`curl -fsSL https://raw.githubusercontent.com/0xAEQI/aeqi/main/scripts/install.sh | sh`}</code></pre>
      ...
      <h2>Docker</h2>
      <pre><code>{`git clone https://github.com/0xAEQI/aeqi && cd aeqi
